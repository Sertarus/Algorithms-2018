...
class AlgorithmsTestsKotlin : AbstractAlgorithmsTests() {
    ...
    fun testLongestCommonSubstring() {
        ...
        assertEquals("", longestCommonSubstring("КАРМАН", "карман"))
...
Еще старушка не забыла
    ...
    fun testBaldaSearcher() {
        ...
        assertEquals(setOf(),
                baldaSearcher("input/balda_in2.txt", setOf("ТРАВА", "КРАН", "АКВА", "НАРТЫ", "РАК")))
        assertEquals(setOf("ТРАВА", "АПЕЛЬСИН", "НОРА"),
                baldaSearcher("input/balda_in3.txt", setOf("ТРАВА", "АПЕЛЬСИН", "НОРА", "РАДАР", "ОБЛАЧНО")))
    }
}